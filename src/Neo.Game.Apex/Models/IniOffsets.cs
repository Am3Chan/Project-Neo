...
namespace Neo.Game.Apex.Models
{
    ...
    public class IniOffsets : IOffsets
    {
        ...
        public uint PlayerGlowColor_R => _ini.Get("RecvTable.DT_HighlightSettings", "m_highlightParams") + 0x18;
        public uint PlayerGlowColor_G => _ini.Get("RecvTable.DT_HighlightSettings", "m_highlightParams") + 0x1C;
        public uint PlayerGlowColor_B => _ini.Get("RecvTable.DT_HighlightSettings", "m_highlightParams") + 0x20;
